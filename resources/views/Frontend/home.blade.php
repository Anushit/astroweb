        ...
        <div class="content-back">
            <div class="content-btn">
              ...
              <div class="row aboutrw">
                <div class="col-md-5">
                  <a href="{{ route('about') }}"><img class="readmorebtn" src="{{ asset('public/assets/img/readmore.png') }}"></a>
                </div>
              </div>
            </div>
         </div>
    ...
    <div class="row ourservice">
      <div class="col-md-6 item2" style="background:#EE600D;">
        <div class="section-title data-aos=">
          ...
          <p>{{ $cms[1]['content']}}</p>
          <a href="{{ route('services') }}"><img class="seeallbtn" src="{{ asset('public/assets/img/seeallbtn.png') }}"></a>
        </div>   
      </div>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row"> 
      ...
      <div class="col-md-8">
            ...
            <div class="row astrocard ">
              <div class="col-md-5">
                <div class="row">
                  ...
                  <div class="col-md-11"><img class="astroimg1" src="{{ asset('public/'.$astro->image) }}"></div>
                </div>
              </div>
              <div class="col-md-7">
        ...
        <div class="row">
          <a class="btn" href="{{ route('astrologer') }}"><img class="viewastro" src="{{ asset('public/assets/img/viewastro.png') }}"></a>
        </div>
      </div>
    </div>
  </div>
